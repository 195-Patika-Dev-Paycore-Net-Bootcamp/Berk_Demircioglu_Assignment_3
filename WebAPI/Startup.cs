...
using DataAccess.StartUpExtensions;
...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IContainerService, ContainerManager>();
            services.AddScoped<IVehicleService, VehicleManager>();
            services.AddScoped<IContainerDal, NhContainerDal>();
            services.AddScoped<IVehicleDal, NhVehicleDal>();
